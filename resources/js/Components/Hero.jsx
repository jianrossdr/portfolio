        ...
        <section className="pt-24 pb-20 md:pt-36 md:pb-28 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto px-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-6 sm:gap-8">
                    ...
                    <div>
                        {/* 2. Main Name Heading */}
                        <h1 className="animate-enter-3 text-4xl sm:text-6xl font-medium tracking-tight text-zinc-100 leading-[1.12]">
                            Jian Ross Dela Rosa
                        </h1>

                        {/* 3. Refined Bio */}
                        <p className="animate-enter-4 mt-4 text-base sm:text-lg text-zinc-400 max-w-2xl leading-relaxed">
